...
function Issuer() {
    ...
    useEffect(() => {
        async function getStatus() {
            const status = await OnescanVerify.methods.issuerAddress(accounts[0]).call()
    ...
    return (
        <Base>
            <div className="IssuerContainer">
                <h3 className="card-title m-2 text-center">Certificate Issuer Portal</h3>
                            ...
                            <div id="register-collapse" className={`accordion-collapse ${!registerStatus?'show':'collapse'}`} aria-labelledby="register-heading" data-bs-parent="#issuerFlush">
                                <div className="accordion-body">
                                    ...
                                    <form className="m-2" style={{ height: '100%' }} onSubmit={onSubmit}>
                                        <div className="mb-3">
                                            <label htmlFor="nameInput" className="form-label">Company/Institution Name</label>
                                            ...
                                            />
                                            <div id="nameHelp" className="form-text">e.g."Your company/institution name."</div>
                                        </div>
                                        <div className="mb-3">
                                            <label htmlFor="CINInput" className="form-label">Company/Institution CIN</label>
                                            <input id="CINInput" aria-describedby="CINHelp" type='text'
                                                ...
                                                readOnly={registerStatus}
                                            />
                                            <div id="CINHelp" className="form-text">e.g."Your company/institution CIN(Certificate of incorporation)."</div>
                                        </div>
                                        <div className="mb-3">
                                            <label htmlFor="PANInput" className="form-label">Company//Institution PAN</label>
                                            <input id="PANInput" aria-describedby="PANHelp" type='text'
                                                ...
                                                readOnly={registerStatus}
                                            />
                                            <div id="PANHelp" className="form-text">e.g."Your company/institution PAN Number."</div>
                                        </div>
                            ...
                            <div id="pending-collapse" className={`accordion-collapse ${registerStatus?'show':'collapse'}`} aria-labelledby="pending-heading" data-bs-parent="#issuerFlush">
                                <div className="accordion-body">
                                    <div className="row mb-3">
                                        <label htmlFor="Company" className="col-lg-4 col-form-label">Company/Institution Name</label>
